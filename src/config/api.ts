...
export function createApiConfig(options: {
  ...
  return {
    manifoldUrl: environment === 'production' ? 'https://api.manifold.xyz' : 'https://api-dev.manifold.xyz',
    studioAppsUrl: environment === 'production' ? 'https://studio.manifold.xyz' : 'https://studio-dev.manifold.xyz',
    timeout: 10000,
    maxRetries: 3,
  };
}
