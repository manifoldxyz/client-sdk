    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'instanceId', type: 'uint256' },
          {
            ...
            internalType: 'struct IGachaLazyClaim.VariationMint[]',
            name: 'variationMints',
            type: 'tuple[]',
          },
        ],
        internalType: 'struct IGachaLazyClaim.ClaimMint[]',
        name: 'mints',
        type: 'tuple[]',
      },
    ],
    ...
    outputs: [
      {
        components: [
          {
            internalType: 'enum IGachaLazyClaim.StorageProtocol',
        ...
        internalType: 'struct IERC1155GachaLazyClaim.Claim',
        name: '',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'struct IGachaLazyClaim.UserMintDetails',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'instanceId', type: 'uint256' },
      {
        ...
        internalType: 'struct IERC1155GachaLazyClaim.ClaimParameters',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'instanceId', type: 'uint256' },
      {
        ...
        internalType: 'struct IERC1155GachaLazyClaim.UpdateClaimParameters',
